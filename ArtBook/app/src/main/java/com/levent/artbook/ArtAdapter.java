...
import com.levent.artbook.databinding.RecyclerRowBinding;
...
public class ArtAdapter extends RecyclerView.Adapter<ArtAdapter.ArtHolder> {
    ...
    //KaçTane Alınacak ArrayList İçindeki İtem Sayısına Bakıp Sölüyoruz
    ...
    public ArtHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        //Bir ArtHolder Oluşturmamız ve Layout ile birbirine bağlamamız lazım
        //binding ile bağlıyoruz
